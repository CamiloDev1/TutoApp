...
import 'package:tuto_app/Widgets/FormCard_teacher.dart';
import 'package:tuto_app/Widgets/SocialIcons.dart';
import 'package:tuto_app/CustomIcons.dart';
import 'package:http/http.dart' as http;

class LoginScreen_teacher extends StatefulWidget {
  @override
  _LoginScreen_teacherState createState() => new _LoginScreen_teacherState();
}

class _LoginScreen_teacherState extends State<LoginScreen_teacher> {
  bool _isSelected = false;
  var message = ".";

  login_teacher(nameStr, passStr) async {
    print("Entro aqui");
    final http.Response response = await http.post(
      'http://52.53.171.98:5000/docentes/login',
    ...
    if (response.statusCode == 200) {
      ...
      SharedPreferences prefs_teachers = await SharedPreferences.getInstance();
      await prefs_teachers.setString('name', jsonData['name']);
      await prefs_teachers.setString('matricula', jsonData['correo']);
      await prefs_teachers.setString('rol', jsonData['rol']);
      print("entro if");
